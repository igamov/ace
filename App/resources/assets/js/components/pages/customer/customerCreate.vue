              ...
              <form v-on:submit.prevent="createCustomer">
                <div class="form-group row">
                  <div class="col">
                    ...
                    <div class="input-group ">
                      <input type="text" v-model="customer.name" :class="'form-control' + (errors.name ? ' is-invalid' : '')"  id="name" placeholder="Название">
                ...
                <div class="form-group row">
                  <div class="col">
                    ...
                    <div class="input-group ">
                      <select  v-model="customer.spokesman_id" id="spokesman_id" :class="'custom-select' + (errors.spokesman_id ? ' is-invalid' : '')">
                ...
                <div class="form-group row">
                  ...
                  <div class="col">
                    ...
                    <div class="input-group">
                      <select  v-model="customer.manager_id" id="manager_id" :class="'custom-select' + (errors.manager_id ? ' is-invalid' : '')">
                ...
                <div class="form-group row">
                  <div class="col">
                    ...
                    <div class="input-group ">
                      <input type="text" v-model="customer.email" :class="'form-control' + (errors.email ? ' is-invalid' : '')" id="email" placeholder="E-mail">
                  ...
                  <div class="col">
                    ...
                    <div class="input-group ">
                      <input type="text" v-model="customer.phone" :class="'form-control' + (errors.phone ? ' is-invalid' : '')" id="phone" placeholder="Телефон">
                  ...
                  <div class="col">
                    ...
                    <div class="input-group ">
                      <input type="text" v-model="customer.site" :class="'form-control' + (errors.site ? ' is-invalid' : '')" id="site" placeholder="Сайт">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" v-model="customer.legal_name" :class="'form-control' + (errors.legal_name ? ' is-invalid' : '')" id="legal_name" placeholder="Полное юридическое название">
                ...
                <div class="form-group row">
                  <div class="col">
                    ...
                    <div class="input-group">
                      <input type="text" v-model="customer.inn" :class="'form-control' + (errors.inn ? ' is-invalid' : '')" id="inn" placeholder="ИНН">
                  ...
                  <div class="col">
                    ...
                    <div class="input-group">
                      <input type="text" v-model="customer.kpp" :class="'form-control' + (errors.kpp ? ' is-invalid' : '')" id="kpp" placeholder="КПП">
                ...
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" v-model="customer.legal_address" :class="'form-control' + (errors.legal_address ? ' is-invalid' : '')" id="legal_address" placeholder="Юридический адрес">
